        ...
        <section className="reoxy-section">
            ...
            <Container className="text-center my-4">
                <p className="fs-5">
                   ...
                   <p> -	Предварителен тест – за оценка на зоната на максимална терапевтична ефикасност и за изчисляване на индивидуалните параметри;</p>
                   <p> -	Терапия – да „задържа” пациента в зоната на максимална терапевтична ефикасност чрез коригиране на параметрите на терапията в отговор на промените в състоянието на пациента</p>
                   <p> -	След терапията – изчисляване и съхраняване на параметрите на терапията в индивидуален протокол.</p>
