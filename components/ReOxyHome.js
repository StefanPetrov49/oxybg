    ...
    <section className="reoxy-home">
      ...
      <div className="white-section">
        ...
        <div className="reoxy-info-section">
          <p>
            <strong>Ai Mediq</strong> с удоволствие представя първото в света медицинско устройство за предоставяне на индивидуализирана, биофийдбек-контролирана интермитентна хипоксия-хипероксия терапия. <strong>ReOxy</strong> е единственото медицинско IHHT устройство в света, което е регулаторно одобрено (TÜV Rheinland) и притежава CE маркировка за професионална употреба в здравеопазването.
          </p>
        </div>
